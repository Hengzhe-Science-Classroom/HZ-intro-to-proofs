// === Introduction to Proofs - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('intro-to-proofs-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('intro-to-proofs-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
